...
```
** the -p option sets the por, while Flask natively runs on port 5000, we set Soseki bank up on port 3000 so both can run simultaneously and transfer money between eachother
